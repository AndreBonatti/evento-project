...
public interface EventoResource {
    ...
    @GET
    @APIResponses(value = {
            @APIResponse(responseCode = "200", description = "BUSCA Paginada", content = @Content(schema = @Schema(implementation = Evento.class))),
    ...
    @Path("{id}")
    @APIResponses(value = {
            @APIResponse(responseCode = "200", description = "BUSCA PELO ID", content = @Content(schema = @Schema(implementation = Evento.class))),
            @APIResponse(responseCode = "400", description = ConstantExceptionMessage.BAD_REQUEST_400),
            @APIResponse(responseCode = "404", description = ConstantExceptionMessage.NOT_FOUND_404),
            @APIResponse(responseCode = "500", description = ConstantExceptionMessage.INTERNAL_SERVER_ERROR_500)
    })
    ...
    @Operation(summary = "Criacao do evento", description = "descricao")
    Response created(@Valid EventoDto eventoDto);
    ...
    @Operation(summary = "Alteracao do evento", description = "descricao")
    Response updated(@PathParam("id") Integer id, @Valid EventoDto eventoDto);
    ...
    @Operation(summary = "Remocao do evento", description = "descricao")
